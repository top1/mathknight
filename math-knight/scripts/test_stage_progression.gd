extends SceneTree
## Automated test script for 10-Stage Progression & 3-Choice System.
...
func _init() -> void:
	...
	var eb_script = load("res://scripts/autoload/EventBus.gd")
	var eb = eb_script.new()
	eb.name = "EventBus"
	root.add_child(eb)
	...
	var rm_script = load("res://scripts/autoload/RunManager.gd")
